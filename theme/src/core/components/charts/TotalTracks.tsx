/**
 * @name TotalTracks
 * @file TotalTracks.tsx
 * @description total tracks analytics component
 */
...
// Utilities
import { CHART_TOOLTIP } from '@core/constants'

ChartJS.register(CategoryScale, BarElement, LinearScale, Tooltip)

const TotalTracks: React.FC = () => {
...
TotalTracks.displayName = 'TotalTracks'
