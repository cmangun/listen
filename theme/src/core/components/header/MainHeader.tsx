...
import type { NavLinkTypes, translationsObjectTypes } from "@core/types"
      ...
      <div className="container">
        <nav className="navbar navbar-expand-lg">
          ...
          <div ref={navRef} className="collapse navbar-collapse" id="top_navbar">
            <ul className="navbar-nav mt-4 mt-lg-0 mx-auto fw-semibold">{NAVBAR_LINK.map((nav) => navLink(nav))}</ul>
          </div>
        </nav>
      </div>
    </header>
