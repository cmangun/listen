    ...
    <div className='dropdown'>
      ...
      <div
        className={replaceClassName(
          'dropdown-menu dropdown-menu-lg dropdown-menu-end lang-dropdown'
        )}
      ...
      >
          ...
          {LANGUAGES.map((lang) => (
            <div key={lang.id} className='py-2 px-4 w-50'>
              <div className='form-check mb-0'>
                <input className='form-check-input' type='checkbox' id={'lang_' + lang.id} />
                <label className='form-check-label fw-medium' htmlFor={'lang_' + lang.id}>
                  {lang.name}
                </label>
              </div>
            </div>
        ...
        <div className='dropdown-divider'></div>
        <div className='py-2 px-4'>
          <button type='button' className='btn btn-primary w-100 justify-content-center'>
            Update
          </button>
        </div>
      </div>
