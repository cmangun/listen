 ...
 * @name Scrollbar
 * @file Scrollbar.tsx
 * @description react-custom-scrollbars-4 scrollbar component
 */

// Modules
import React from 'react'
import { Scrollbars, ScrollbarProps } from 'react-custom-scrollbars-4'
...
const Scrollbar: React.FC<ScrollbarProps> = (props) => {
  ...
  const getViewMargin = (style: React.CSSProperties) => {
    ...
    return rtl ? { marginLeft: marginRight, marginRight: 0 } : { marginRight: marginRight }
  }
