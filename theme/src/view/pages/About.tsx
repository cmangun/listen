...
function About() {
  ...
  const aboutPage: translationsObjectTypes = t('about_page', { returnObjects: true })
    ...
    <>
      ...
      <div className='main-section pb-0'>
        <div className='container'>
          <div className='col-xl-9 col-lg-10'>
            <h1 className='mb-0' dangerouslySetInnerHTML={{ __html: aboutPage.title }} />
          </div>
        </div>
      </div>
          ...
          <div className='row g-5'>
            ...
            <div className='col-lg-7 fs-5'>
              <div className={replaceClassName('pe-5')}>
                <h2 className='my-4' dangerouslySetInnerHTML={{ __html: aboutPage.story_title }} />
      ...
      <div className='main-section bg-light'>
        <div className='container text-center'>
          <h2 className='mb-5' dangerouslySetInnerHTML={{ __html: aboutPage.works_title }} />
      ...
      <div className='main-section'>
        <div className='container'>
          <div className='col-xl-6 col-lg-8 mx-auto text-center fs-5 mb-5'>
            <h2 dangerouslySetInnerHTML={{ __html: aboutPage.team_title }} />
          ...
          <div className='row g-5 justify-content-center'>
            <div className='col-xl-2 col-lg-3 col-sm-4 col-6'>
              ...
              <div className='avatar avatar--xxl d-block text-center'>
                <div className='avatar__image mx-auto'>
                  <img src='/images/users/thumb.jpg' width={128} height={128} alt='Arebica Luna' />
                </div>
                ...
                <ul className='social justify-content-center'>
                  ...
                  <li>
                    <Link to='#' aria-label='X' target='_blank'>
            ...
            <div className='col-xl-2 col-lg-3 col-sm-4 col-6'>
              ...
              <div className='avatar avatar--xxl d-block text-center'>
                <div className='avatar__image mx-auto'>
                  <img src='/images/users/thumb-2.jpg' width={128} height={128} alt='Aida Bugg' />
                </div>
            ...
            <div className='col-xl-2 col-lg-3 col-sm-4 col-6'>
              ...
              <div className='avatar avatar--xxl d-block text-center'>
                <div className='avatar__image mx-auto'>
                  <img src='/images/users/thumb-3.jpg' width={128} height={128} alt='Teri Dactyl' />
                </div>
            ...
            <div className='col-xl-2 col-lg-3 col-sm-4 col-6'>
              ...
              <div className='avatar avatar--xxl d-block text-center'>
                <div className='avatar__image mx-auto'>
                  <img src='/images/users/thumb-4.jpg' width={128} height={128} alt='Peg Legge' />
                </div>
