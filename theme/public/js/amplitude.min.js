  ...
  return (function (e) {
    ...
    function (e, t, a) {
      ...
      var u = a(0),
        ...
        _ = (function () {
          ...
          function a() {
            y.default.stop(),
              0 != n.default.audio.currentTime && (n.default.audio.currentTime = 0),
              n.default.audio.pause(),
              n.default.active_metadata.live && d(),
              m.default.setPlayerState(),
              r.default.run('stop')
          ...
          function u(e) {
            n.default.active_metadata.live ||
              (n.default.audio.currentTime = n.default.audio.duration * (e / 100))
          }
          function i(e) {
        ...
        n = (function () {
          ...
          function n() {
            for (
              var e = u.default.audio.paused ? 'paused' : 'playing',
                t =
                  '' != u.default.active_playlist && null != u.default.active_playlist
        ...
        P = (function () {
          function e() {
            ...
            n.default.repeat_song
              ...
              : n.default.shuffle_on
                ? (parseInt(n.default.active_index) + 1 < n.default.shuffle_list.length
                ...
                : (parseInt(n.default.active_index) + 1 < n.default.songs.length
                  ...
                  (a = n.default.songs[t])),
              u(a, t),
              (l && !n.default.repeat) || (e && !n.default.repeat && l) || d.default.play(),
              p.default.sync(),
              o.default.run('next'),
          ...
          function t(e) {
            ...
            n.default.repeat_song
              ? n.default.playlists[e].shuffle
                ...
                : ((a = n.default.playlists[e].active_index), (l = n.default.playlists[e].songs[a]))
              : n.default.playlists[e].shuffle
              ...
              c(e),
              i(e, l, a),
              (u && !n.default.repeat) || (t && !n.default.repeat && u) || d.default.play(),
              p.default.sync(),
              o.default.run('next'),
              n.default.repeat_song && o.default.run('song_repeated')
          }
          function a() {
            ...
            n.default.repeat_song
              ? n.default.shuffle_on
                ? ((e = n.default.active_index), (t = n.default.shuffle_list[e]))
              ...
              : ((e =
                ...
                (t = n.default.shuffle_on ? n.default.shuffle_list[e] : n.default.songs[e])),
              u(t, e),
              d.default.play(),
              p.default.sync(),
              o.default.run('prev'),
          ...
          function l(e) {
            ...
            n.default.repeat_song
              ? n.default.playlists[e].shuffle
                ...
                : ((t = n.default.playlists[e].active_index), (a = n.default.playlists[e].songs[t]))
              : ((t =
          ...
          function e(e, t) {
            return (
              ...
              (null == u.default.active_playlist && null == e
                ...
                : u.default.active_playlist == e && u.default.playlists[e].active_index != t)
            )
          }
          function t(e) {
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          function e() {
            for (
              var e = ['cover_art_url', 'station_art_url', 'podcast_episode_cover_art_url'],
              ...
              if (null == i && (u.default.active_playlist == n || (null == n && null == i))) {
                ...
                e.indexOf(l) >= 0
                  ? ((d = d || u.default.default_album_art), t[a].setAttribute('src', d))
                  : ((d = d || ''), (t[a].innerHTML = d))
              }
            }
          }
          ...
          function a(e, t) {
            for (
              var a = ['cover_art_url', 'station_art_url', 'podcast_episode_cover_art_url'],
                l = document.querySelectorAll(
                  '[data-amplitude-song-info][data-amplitude-playlist="' + t + '"]'
                ),
                u = 0;
              u < l.length;
              u++
          ...
          function l() {
            for (
              ...
              if (null != n && null == i) {
                ...
                e.indexOf(d) >= 0
                  ? ((s = s || u.default.default_album_art), a[l].setAttribute('src', s))
                  : (a[l].innerHTML = s)
              }
              if (null != n && null != i) {
                ...
                void 0 != u.default.playlists[i].songs[n][o] &&
                  (e.indexOf(o) >= 0
                    ? a[l].setAttribute('src', u.default.playlists[i].songs[n][o])
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          function e() {
            for (
              var e = document.getElementsByClassName('amplitude-repeat'), t = 0;
              t < e.length;
              t++
            )
              u.default.repeat
          ...
          function t(e) {
            for (
              var t = document.getElementsByClassName('amplitude-repeat'), a = 0;
              a < t.length;
              a++
            )
          ...
          function a() {
            for (
              var e = document.getElementsByClassName('amplitude-repeat-song'), t = 0;
              t < e.length;
              t++
            )
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          function e() {
            for (
              var e = document.getElementsByClassName('amplitude-volume-slider'), t = 0;
              t < e.length;
              t++
            )
        ...
        n = (function () {
          ...
          function a(e, t) {
            ;(u.default.playlists[e].shuffle = t),
              u.default.playlists[e].shuffle ? i(e) : (u.default.playlists[e].shuffle_list = [])
          }
          function l(e) {
            u.default.playlists[e].shuffle
              ? ((u.default.playlists[e].shuffle = !1), (u.default.playlists[e].shuffle_list = []))
              : ((u.default.playlists[e].shuffle = !0), i(e))
          }
          function n() {
            for (var e = new Array(u.default.songs.length), t = 0; t < u.default.songs.length; t++)
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function t(e) {
            e = isNaN(e) ? 0 : e
            for (
              var t = document.querySelectorAll('.amplitude-song-slider'), a = 0;
              a < t.length;
              a++
            ) {
              var l = t[a].getAttribute('data-amplitude-playlist'),
          ...
          function l(e, t) {
            if (null == u.default.active_playlist) {
              ...
              for (
                var a = document.querySelectorAll(
                    '.amplitude-song-slider[data-amplitude-song-index="' + t + '"]'
                  ),
                  l = 0;
                l < a.length;
                l++
          ...
          function i() {
            for (
              var e = document.getElementsByClassName('amplitude-song-slider'), t = 0;
              t < e.length;
              t++
            )
              e[t].value = 0
          ...
          (function () {
            function e() {
              ...
              if (n.default.web_audio_api_available) {
                if (Object.keys(n.default.visualizations.available).length > 0 && e.length > 0)
                ...
                a =
                  null != n.default.active_index
                    ...
                    : n.default.playlists[n.default.active_playlist].songs[
                        n.default.playlists[n.default.active_playlist].active_index
                      ].visualization
              if (void 0 != a && void 0 != n.default.visualizations.available[a]) i(a, e)
              else if (void 0 != t && void 0 != n.default.visualizations.available[t]) i(t, e)
              else {
                var l =
            ...
            function a(e, t) {
              if (t == n.default.active_playlist) {
                var a =
                  ...
                  l = n.default.playlists[n.default.active_playlist].visualization,
                  u = n.default.visualization
                if (void 0 != a && void 0 != n.default.visualizations.available[a]) i(a, e)
                else if (void 0 != l && void 0 != n.default.visualizations.available[l]) i(l, e)
                else if (void 0 != u && void 0 != n.default.visualizations.available[u]) i(u, e)
                else {
                  var d =
                    Object.keys(n.default.visualizations.available).length > 0
                      ? Object.keys(n.default.visualizations.available)[0]
            ...
            function u(e, t, a) {
              if (t == n.default.active_playlist && n.default.playlists[t].active_index == a) {
                var l =
                  ...
                  u = n.default.playlists[n.default.active_playlist].visualization,
                  d = n.default.visualization
                if (void 0 != l && void 0 != n.default.visualizations.available[l]) i(l, e)
                else if (void 0 != u && void 0 != n.default.visualizations.available[u]) i(u, e)
                else if (void 0 != d && void 0 != n.default.visualizations.available[d]) i(d, e)
                else {
                  var s =
                    Object.keys(n.default.visualizations.available).length > 0
                      ? Object.keys(n.default.visualizations.available)[0]
            ...
            function i(e, t) {
              ...
              a.setPreferences(n.default.visualizations.available[e].preferences),
          ...
          function a() {
            for (
              ...
              n.default.songs[t].url.match(e) &&
                (n.default.soundcloud_song_count++, u(n.default.songs[t].url, t))
          }
          function l(e, t, a) {
            var l = arguments.length > 3 && void 0 !== arguments[3] && arguments[3]
                ...
                ? null != t
                  ? ((n.default.playlists[t].songs[a].url =
                    ...
                    n.default.soundcloud_use_art &&
                      ((n.default.playlists[t].songs[a].cover_art_url = e.artwork_url),
                      l && (n.default.playlists[t].shuffle_list[a].cover_art_url = e.artwork_url)),
                    (n.default.playlists[t].songs[a].soundcloud_data = e),
                    l && (n.default.playlists[t].shuffle_list[a].soundcloud_data = e))
                  : ((n.default.songs[a].url =
                      e.stream_url + '?client_id=' + n.default.soundcloud_client),
                    l && (n.default.shuffle_list[a].stream_url, n.default.soundcloud_client),
                    n.default.soundcloud_use_art &&
                      ((n.default.songs[a].cover_art_url = e.artwork_url),
                      l && (n.default.shuffle_list[a].cover_art_url = e.artwork_url)),
          ...
          function u(e, t) {
            SC.get('/resolve/?url=' + e, function (e) {
              e.streamable
                ...
                ++n.default.soundcloud_songs_ready == n.default.soundcloud_song_count &&
                  d.default.setConfig(s)
            })
          }
          function i(e) {
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          function e() {
            for (
              var e = document.getElementsByClassName('amplitude-playback-speed'), t = 0;
              t < e.length;
              t++
            )
              switch (
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          function e() {
            for (
              var e = document.getElementsByClassName('amplitude-shuffle'), t = 0;
              t < e.length;
              t++
            )
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function t(e) {
            if (!isNaN(e))
              for (
                var t = document.querySelectorAll('.amplitude-song-played-progress'), a = 0;
                a < t.length;
                a++
              ) {
                var l = t[a].getAttribute('data-amplitude-playlist'),
          ...
          function i() {
            for (
              var e = document.getElementsByClassName('amplitude-song-played-progress'), t = 0;
              t < e.length;
              t++
            )
              e[t].value = 0
    ...
    function (e, t, a) {
      ...
      var u =
        ...
        J = (function () {
            ...
            if (
              ...
              e.songs
                ? 0 != e.songs.length
                  ...
                  : v.default.writeMessage('Please add some songs, to your songs object!')
                : v.default.writeMessage('Please provide a songs object for AmplitudeJS to run!'),
              ...
              if (
                ...
                for (var u = 0; u < e.visualizations.length; u++)
                  P.default.register(e.visualizations[u].object, e.visualizations[u].params)
            } else
          ...
          function a(e) {
            e.playlists && d(e.playlists) > 0 && C.default.initialize(e.playlists),
              void 0 == e.start_song || e.starting_playlist
                ? E.default.changeSong(i.default.songs[0], 0)
                : g.default.isInt(e.start_song)
                  ? E.default.changeSong(i.default.songs[e.start_song], e.start_song)
                  : v.default.writeMessage('You must enter an integer index for the start song.'),
              void 0 != e.shuffle_on &&
                e.shuffle_on &&
                ((i.default.shuffle_on = !0),
                _.default.shuffleSongs(),
                E.default.changeSong(i.default.shuffle_list[0], 0)),
              (i.default.continue_next = void 0 == e.continue_next || e.continue_next),
              (i.default.playback_speed = void 0 != e.playback_speed ? e.playback_speed : 1),
              s.default.setPlaybackSpeed(i.default.playback_speed),
              (i.default.audio.preload = void 0 != e.preload ? e.preload : 'auto'),
              ...
              (i.default.volume_increment = void 0 != e.volume_increment ? e.volume_increment : 5),
              (i.default.volume_decrement = void 0 != e.volume_decrement ? e.volume_decrement : 5),
              ...
              void 0 != e.starting_playlist &&
                ...
                void 0 != e.starting_playlist_song && '' != e.starting_playlist_song
                  ? void 0 !=
                    u(e.playlists[e.starting_playlist].songs[parseInt(e.starting_playlist_song)])
                    ? E.default.changeSongPlaylist(
                        i.default.active_playlist,
                        e.playlists[e.starting_playlist].songs[parseInt(e.starting_playlist_song)],
          ...
          function o() {
            for (var e = 0; e < i.default.songs.length; e++)
              void 0 == i.default.songs[e].live && (i.default.songs[e].live = !1)
          }
          function r() {
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
              ...
              if (
                ...
                e.open('GET', u.default.audio.src, !0),
                  ...
                  (e.onreadystatechange = function (t) {
                    4 == e.readyState &&
                      200 == e.status &&
                      u.default.context.decodeAudioData(e.response, function (e) {
                        ;(r = e), (p = l(c, r)), a(c, r, p)
                      })
                  }),
                  e.send()
          ...
          function l(e, t) {
            for (
              var a = t.length / e, l = ~~(a / 10) || 1, u = t.numberOfChannels, n = [], i = 0;
              i < u;
              i++
            )
      ...
      var l = a(0),
        ...
        n = (function () {
          function e() {
            ...
            return (
              a < 10 && (a = '0' + a),
              a >= 60 && ((l = Math.floor(a / 60)), (a %= 60) < 10 && (a = '0' + a)),
              (e.seconds = t),
              (e.minutes = a),
              (e.hours = l),
              e
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function t() {
            for (
              var e = document.getElementsByClassName('amplitude-buffered-progress'), t = 0;
              t < e.length;
              t++
            ) {
              var a = e[t].getAttribute('data-amplitude-playlist'),
          ...
          function n() {
            for (
              var e =
                  null != u.default.active_playlist && '' != u.default.active_playlist
                    ? u.default.playlists[u.default.active_playlist].active_index
                    : null,
                t = document.querySelectorAll(
                  '.amplitude-buffered-progress[data-amplitude-song-index="' +
          ...
          function e() {
            setTimeout(function () {
              n.default.continue_next
                ...
                : n.default.is_touch_moving || (o.default.stop(), r.default.sync())
            }, n.default.delay)
          }
          return { handle: e }
        })()
    ...
    function (e, t, a) {
      ...
      var u = a(0),
        ...
        $ = (function () {
          function e() {
            J.default.writeMessage('Beginning initialization of event handlers..'),
          ...
          function t() {
            n.default.audio.removeEventListener('timeupdate', o.default.handle),
              ...
              n.default.audio.removeEventListener('durationchange', o.default.handle),
              n.default.audio.addEventListener('durationchange', o.default.handle)
          }
          function a() {
          ...
          function f() {
            for (
              var e = document.getElementsByClassName('amplitude-play-pause'), t = 0;
              t < e.length;
              t++
            )
              /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          ...
          function g() {
            for (
              var e = document.getElementsByClassName('amplitude-volume-up'), t = 0;
              t < e.length;
              t++
            )
              /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          ...
          function _() {
            for (
              var e = document.getElementsByClassName('amplitude-volume-down'), t = 0;
              t < e.length;
              t++
            )
              /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          ...
          function q() {
            for (
              var e = document.getElementsByClassName('amplitude-skip-to'), t = 0;
              t < e.length;
              t++
            )
              /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          ...
          function H() {
            Y.default.determineIfUsingWaveforms() &&
              (n.default.audio.removeEventListener('canplaythrough', Y.default.build),
              n.default.audio.addEventListener('canplaythrough', Y.default.build))
          }
          return { initialize: e }
        })()
          ...
          function e() {
            n.default.is_touch_moving ||
              (0 == n.default.volume
                ...
                : ((n.default.pre_mute_volume = n.default.volume), d.default.setVolume(0)),
        ...
        y = (function () {
          ...
          function a(e) {
            f.default.newPlaylist(e) &&
              ...
              n.default.playlists[e].shuffle
                ? c.default.changeSongPlaylist(e, n.default.playlists[e].shuffle_list[0], 0)
                : c.default.changeSongPlaylist(e, n.default.playlists[e].songs[0], 0)),
              s.default.play(),
              v.default.sync()
          }
          function l(e) {
            f.default.newPlaylist(null) &&
              (c.default.setActivePlaylist(null), c.default.changeSong(n.default.songs[e], e)),
              f.default.newSong(null, e) && c.default.changeSong(n.default.songs[e], e),
              s.default.play(),
              v.default.sync()
          }
          function u(e, t) {
            f.default.newPlaylist(e) &&
              (c.default.setActivePlaylist(e),
              c.default.changeSongPlaylist(e, n.default.playlists[e].songs[t], t)),
        ...
        y = (function () {
          ...
          function a(e) {
            f.default.newPlaylist(e) &&
              (c.default.setActivePlaylist(e),
              n.default.playlists[e].shuffle
                ? c.default.changeSongPlaylist(e, n.default.playlists[e].shuffle_list[0], 0, !0)
                : c.default.changeSongPlaylist(e, n.default.playlists[e].songs[0], 0)),
          ...
          function l(e) {
            f.default.newPlaylist(null) &&
              (c.default.setActivePlaylist(null), c.default.changeSong(n.default.songs[e], e, !0)),
              f.default.newSong(null, e) && c.default.changeSong(n.default.songs[e], e, !0),
              n.default.audio.paused ? s.default.play() : s.default.pause(),
              v.default.sync()
          }
          function u(e, t) {
            f.default.newPlaylist(e) &&
              (c.default.setActivePlaylist(e),
              c.default.changeSongPlaylist(e, n.default.playlists[e].songs[t], t, !0)),
              f.default.newSong(e, t) &&
                c.default.changeSongPlaylist(e, n.default.playlists[e].songs[t], t, !0),
              n.default.audio.paused ? s.default.play() : s.default.pause(),
              v.default.sync()
    ...
    function (e, t, a) {
      ...
      var u = a(0),
        ...
        f = (function () {
          function e() {
            n.default.is_touch_moving ||
              (d.default.setRepeatSong(!n.default.repeat_song), o.default.syncRepeatSong())
          }
          return { handle: e }
        })()
      ;(t.default = f), (e.exports = t.default)
        ...
        g = (function () {
          function e() {
            if (!n.default.is_touch_moving) {
              ...
              null == u &&
                ...
                null != u &&
                  null != l &&
                  (null == e ? t(parseInt(l), parseInt(u)) : a(e, parseInt(l), parseInt(u)))
            }
          }
          function t(e, t) {
          ...
          function a(e, t, a) {
            r.default.newPlaylist(e) && o.default.setActivePlaylist(e),
              o.default.changeSongPlaylist(e, n.default.playlists[e].songs[t], t),
              p.default.play(),
              y.default.syncGlobal(),
        ...
        f = (function () {
          ...
          function t(e, t) {
            n.default.active_metadata.live ||
              ...
              o.default.sync(t, n.default.active_playlist, n.default.active_index))
          }
          function a(e, t, a) {
            n.default.active_playlist == a &&
              (n.default.active_metadata.live ||
                (d.default.setCurrentTime(e), o.default.sync(t, a, n.default.active_index)))
          }
          function l(e, t, a) {
            n.default.active_index == a &&
              null == n.default.active_playlist &&
              (n.default.active_metadata.live ||
                (d.default.setCurrentTime(e), o.default.sync(t, n.default.active_playlist, a)))
          }
          function u(e, t, a, l) {
            ...
            function a() {
              if (!n.default.active_metadata.live) {
                ...
                o.default.syncCurrentTimes(e),
                  r.default.sync(t, n.default.active_playlist, n.default.active_index),
                  p.default.sync(t),
          ...
          function e() {
            ...
            e
              ? ((u.default.context = new e()),
                ...
                (u.default.source = u.default.context.createMediaElementSource(u.default.audio)),
        ...
        R = (function () {
          ...
          function M(e) {
            d.default.is_touch_moving ||
              (g.default.setRepeatSong(!d.default.repeat_song), P.default.syncRepeatSong())
          }
          function S() {
          ...
          function B(e) {
            'number' == typeof e &&
              e > 0 &&
              e < 100 &&
              (d.default.audio.currentTime = d.default.audio.duration * (e / 100))
          }
          function R(e) {
            d.default.debug = e
          }
          ...
          function X(e, t) {
            return void 0 != d.default.playlists[t]
              ? (d.default.playlists[t].songs.push(e),
                d.default.playlists[t].shuffle && d.default.playlists[t].shuffle_list.push(e),
                D.default.isSoundCloudURL(e.url) &&
                  D.default.resolveIndividualStreamableURL(
                    e.url,
                    t,
          ...
          function Z(e) {
            o.default.stop(),
              _.default.newPlaylist(null) &&
                (v.default.setActivePlaylist(null), v.default.changeSong(d.default.songs[e], e)),
              _.default.newSong(null, e) && v.default.changeSong(d.default.songs[e], e),
              o.default.play(),
              C.default.sync()
          }
          function ee(e, t) {
            o.default.stop(),
              _.default.newPlaylist(t) &&
                ...
                v.default.changeSongPlaylist(t, d.default.playlists[t].songs[e], e)),
          ...
          function ie() {
            ...
            '' == e || null == e
              ? null == d.default.active_playlist || '' == d.default.active_playlist
                ? v.default.setNext()
            ...
            ;(e = parseInt(e)),
              null != a
                ? (_.default.newPlaylist(a) && v.default.setActivePlaylist(a),
                  v.default.changeSongPlaylist(a, d.default.playlists[a].songs[t], t),
                  o.default.play(),
          ...
          function me(e, t) {
            if (void 0 != d.default.playlists[e]) {
              ...
              for (var l in t)
                t.hasOwnProperty(l) && a.indexOf(l) < 0 && (d.default.playlists[e][l] = t[l])
          ...
          function xe(e, t) {
            void 0 != d.default.playlists[e]
              ? void 0 != d.default.visualizations.available[t]
                ...
                : H.default.writeMessage('A visualization does not exist for the key provided.')
              : H.default.writeMessage('The playlist for the key provided does not exist')
          }
          function Me(e, t) {
            d.default.songs[e]
              ? void 0 != d.default.visualizations.available[t]
          ...
          function Pe(e, t, a) {
            void 0 != d.default.playlists[e].songs[t]
              ? void 0 != d.default.visualizations.available[a]
                ...
                : H.default.writeMessage('A visualization does not exist for the key provided.')
              : H.default.writeMessage('The song in the playlist at that key is not defined')
          }
          function Se(e) {
        ...
        v = (function () {
          ...
          function a() {
            for (var e in n.default.playlists)
              if (n.default.playlists.hasOwnProperty(e) && n.default.playlists[e].songs)
          ...
          function l() {
            for (var e in n.default.playlists)
              if (n.default.playlists.hasOwnProperty(e))
                for (var t = 0; t < n.default.playlists[e].songs.length; t++)
                  p.default.isSoundCloudURL(n.default.playlists[e].songs[t].url) &&
          ...
          function f() {
            for (var e in n.default.playlists)
              r.default.setFirstSongInPlaylist(n.default.playlists[e].songs[0], e)
          }
          return { initialize: e }
        })()
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          function e(e) {
            for (
              var t = document.getElementsByClassName('amplitude-song-container'), a = 0;
              a < t.length;
              a++
            )
            ...
            if ('' == u.default.active_playlist || null == u.default.active_playlist) {
              ...
              if (
                ...
                document.querySelectorAll(
                  '.amplitude-song-container[data-amplitude-song-index="' + l + '"]'
                ))
              )
                for (
              ...
              if ((null != u.default.active_playlist && '' != u.default.active_playlist) || e)
                var d = u.default.playlists[u.default.active_playlist].active_index
              else {
                var d = ''
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function t(e) {
            for (
              var t = document.querySelectorAll('.amplitude-current-hours'), a = 0;
              a < t.length;
              a++
            ) {
              var l = t[a].getAttribute('data-amplitude-playlist'),
          ...
          function i() {
            for (
              var e = document.querySelectorAll('.amplitude-current-hours'), t = 0;
              t < e.length;
              t++
            )
              e[t].innerHTML = '00'
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function t(e) {
            for (
              var t = document.querySelectorAll('.amplitude-current-minutes'), a = 0;
              a < t.length;
              a++
            ) {
              var l = t[a].getAttribute('data-amplitude-playlist'),
          ...
          function i() {
            for (
              var e = document.querySelectorAll('.amplitude-current-minutes'), t = 0;
              t < e.length;
              t++
            )
              e[t].innerHTML = '00'
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function t(e) {
            for (
              var t = document.querySelectorAll('.amplitude-current-seconds'), a = 0;
              a < t.length;
              a++
            ) {
              var l = t[a].getAttribute('data-amplitude-playlist'),
          ...
          function i() {
            for (
              var e = document.querySelectorAll('.amplitude-current-seconds'), t = 0;
              t < e.length;
              t++
            )
              e[t].innerHTML = '00'
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function i() {
            for (
              var e = document.querySelectorAll('.amplitude-current-time'), t = 0;
              t < e.length;
              t++
            )
              e[t].innerHTML = '00:00'
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function t(e) {
            for (
              var t = document.querySelectorAll('.amplitude-time-remaining'), a = 0;
              a < t.length;
              a++
            ) {
              var l = t[a].getAttribute('data-amplitude-playlist'),
          ...
          function i() {
            for (
              var e = document.querySelectorAll('.amplitude-time-remaining'), t = 0;
              t < e.length;
              t++
            )
              e[t].innerHTML = '00'
          ...
          function d(e, t) {
            var a = '00:00',
              l = parseInt(e.seconds) + 60 * parseInt(e.minutes) + 60 * parseInt(e.hours) * 60,
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function t(e) {
            for (
              var t = document.querySelectorAll('.amplitude-duration-hours'), a = 0;
              a < t.length;
              a++
            ) {
              var l = t[a].getAttribute('data-amplitude-playlist'),
          ...
          function i() {
            for (
              var e = document.querySelectorAll('.amplitude-duration-hours'), t = 0;
              t < e.length;
              t++
            )
              e[t].innerHTML = '00'
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function t(e) {
            for (
              var t = document.querySelectorAll('.amplitude-duration-minutes'), a = 0;
              a < t.length;
              a++
            ) {
              var l = t[a].getAttribute('data-amplitude-playlist'),
          ...
          function i() {
            for (
              var e = document.querySelectorAll('.amplitude-duration-minutes'), t = 0;
              t < e.length;
              t++
            )
              e[t].innerHTML = '00'
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function t(e) {
            for (
              var t = document.querySelectorAll('.amplitude-duration-seconds'), a = 0;
              a < t.length;
              a++
            ) {
              var l = t[a].getAttribute('data-amplitude-playlist'),
          ...
          function i() {
            for (
              var e = document.querySelectorAll('.amplitude-duration-seconds'), t = 0;
              t < e.length;
              t++
            )
              e[t].innerHTML = '00'
    ...
    function (e, t, a) {
      ...
      var l = a(0),
        ...
        n = (function () {
          ...
          function t(e) {
            for (
              var t = document.querySelectorAll('.amplitude-duration-time'), a = 0;
              a < t.length;
              a++
            ) {
              var l = t[a].getAttribute('data-amplitude-playlist'),
          ...
          function i() {
            for (
              var e = document.querySelectorAll('.amplitude-duration-time'), t = 0;
              t < e.length;
              t++
            )
              e[t].innerHTML = '00:00'
